...
.form-control:focus {
  ...
  border-color: #656565;
  outline: none;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(37, 37, 37, 0.25);
}
...
.btn:not([disabled]):not(.disabled):active, .btn:not([disabled]):not(.disabled).active {
  background-image: none;
  box-shadow: 0 0 0 0.2rem rgba(37, 37, 37, 0.25), inset 0 3px 5px rgba(0, 0, 0, 0.125);
}
...
.btn-primary {
  color: #fff;
  background: #252525 linear-gradient(180deg, #464646, #252525) repeat-x;
  border-color: #252525;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075);
}
.btn-primary:hover {
  color: #fff;
  background: #121212 linear-gradient(180deg, #363636, #121212) repeat-x;
  border-color: #0c0c0c;
}
.btn-primary:focus, .btn-primary.focus {
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(37, 37, 37, 0.5);
}
...
.custom-control-input:active ~ .custom-control-indicator {
  color: #fff;
  background: #7e7e7e linear-gradient(180deg, #919191, #7e7e7e) repeat-x;
  box-shadow: none;
}
...
.custom-file-input:focus ~ .custom-file-control {
  box-shadow: 0 0 0 0.075rem #fff, 0 0 0 0.2rem #252525;
}
...
.bg-gradient-primary {
  background: #252525 linear-gradient(180deg, #464646, #252525) repeat-x !important;
}
